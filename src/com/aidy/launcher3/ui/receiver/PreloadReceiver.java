...
public class PreloadReceiver extends BroadcastReceiver {
	...
	public static final String EXTRA_WORKSPACE_NAME = "com.aidy.launcher3.action.EXTRA_WORKSPACE_NAME";
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (provider != null) {
			...
			final int workspaceResId = !TextUtils.isEmpty(name) ? context.getResources().getIdentifier(name, "xml",
					"com.aidy.launcher3") : 0;
			if (LOGD) {
