...
public class LauncherAppState {
	...
	private static final String SHARED_PREFERENCES_KEY = "com.aidy.launcher3.prefs";
	...
	public DeviceProfile initDynamicGrid(Context context, int minWidth, int minHeight, int width, int height,
		...
		if (mDynamicGrid == null) {
			mDynamicGrid = new DynamicGrid(context, context.getResources(), minWidth, minHeight, width, height,
