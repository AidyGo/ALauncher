...
public class SavedWallpaperImagesAdapter extends BaseAdapter implements ListAdapter {
	...
	public static class SavedWallpaperTile extends WallpaperTileInfo {
		private int mDbId;
		...
		public void onClick(WallpaperPickerActivity a) {
			...
			int rotation = WallpaperUtils.getRotationFromExif(file.getAbsolutePath());
	...
	public SavedWallpaperImagesAdapter(Activity context) {
	...
	public void loadThumbnailsAndImageIdList() {
		...
		Cursor result = db.query(ImageDb.TABLE_NAME, new String[] { ImageDb.COLUMN_ID, ImageDb.COLUMN_IMAGE_THUMBNAIL_FILENAME }, // cols
																																	// to
																																	// return
				null, // select query
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		return WallpaperUtils.createImageTileView(mLayoutInflater, position, convertView, parent, thumbDrawable);
	}
	...
	private Pair<String, String> getImageFilenames(int id) {
		...
		Cursor result = db.query(ImageDb.TABLE_NAME,
				new String[] { ImageDb.COLUMN_IMAGE_THUMBNAIL_FILENAME, ImageDb.COLUMN_IMAGE_FILENAME }, // cols
																											// to
																											// return
	...
	static class ImageDb extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase database) {
			database.execSQL("CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (" + COLUMN_ID + " INTEGER NOT NULL, "
					+ COLUMN_IMAGE_THUMBNAIL_FILENAME + " TEXT NOT NULL, " + COLUMN_IMAGE_FILENAME + " TEXT NOT NULL, " + "PRIMARY KEY ("
					+ COLUMN_ID + " ASC) " + ");");
		}
