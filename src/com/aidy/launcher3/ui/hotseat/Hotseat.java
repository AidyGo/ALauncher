...
package com.aidy.launcher3.ui.hotseat;
...
import com.aidy.launcher3.ui.listener.HotseatIconKeyEventListener;
...
public class Hotseat extends FrameLayout {
	...
	public void addAllAppsFolder(IconCache iconCache, ArrayList<AppInfoBean> allApps,
			ArrayList<ComponentName> onWorkspace, Launcher launcher, Workspace workspace) {
		if (AppsCustomizePagedView.DISABLE_ALL_APPS) {
			FolderInfoBean fi = new FolderInfoBean();
	...
	public void addAppsToAllAppsFolder(ArrayList<AppInfoBean> apps) {
		if (AppsCustomizePagedView.DISABLE_ALL_APPS) {
			...
			FolderInfoBean info = fi.getFolderInfo();
			for (AppInfoBean a : apps) {
