...
package com.aidy.launcher3.ui.folder;
...
import com.aidy.launcher3.bean.FolderInfoBean.FolderListener;
...
public class FolderIcon extends LinearLayout implements FolderListener {
	...
	public static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group, FolderInfoBean folderInfo,
			IconCache iconCache) {
	...
	private boolean willAcceptItem(ItemInfoBean item) {
	...
	public boolean acceptDrop(Object dragInfo) {
		final ItemInfoBean item = (ItemInfoBean) dragInfo;
	...
	public void onDragEnter(Object dragInfo) {
		if (mFolder.isDestroyed() || !willAcceptItem((ItemInfoBean) dragInfo))
			return;
	...
	public void onDrop(DragObject d) {
		...
		if (d.dragInfo instanceof AppInfoBean) {
			...
			item = ((AppInfoBean) d.dragInfo).makeShortcut();
		} else {
