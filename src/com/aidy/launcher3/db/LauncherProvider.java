...
import com.aidy.launcher3.config.ProviderConfig;
...
public class LauncherProvider extends ContentProvider {
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
				...
				while (c.moveToNext()) {
					...
					try {
						...
						if (bitmap != null) {
							...
							data = ItemInfoBean.flattenBitmap(bitmap);
							if (data != null) {
		...
		private boolean addAppWidget(XmlResourceParser parser, AttributeSet attrs, int type, SQLiteDatabase db,
				ContentValues values, TypedArray a, PackageManager packageManager) throws XmlPullParserException,
				IOException {
