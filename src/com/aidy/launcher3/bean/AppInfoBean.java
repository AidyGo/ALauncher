...
import com.aidy.launcher3.db.LauncherSettings.BaseLauncherColumns;
...
public class AppInfoBean extends ItemInfoBean {
	 ...
	 */
	public AppInfoBean(PackageManager pm, ResolveInfo info, IconCache iconCache,
			HashMap<Object, CharSequence> labelCache) {
		final String packageName = info.activityInfo.applicationInfo.packageName;

		this.componentName = new ComponentName(packageName, info.activityInfo.name);
		this.container = ItemInfoBean.NO_ID;
	...
	public AppInfoBean(AppInfoBean info) {
		super(info);
	...
	public static void dumpApplicationInfoList(String tag, String label, ArrayList<AppInfoBean> list) {
		Log.d(tag, label + " size=" + list.size());
		for (AppInfoBean info : list) {
