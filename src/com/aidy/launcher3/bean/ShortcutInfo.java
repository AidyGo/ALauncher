 ...
 */
public class ShortcutInfo extends ItemInfoBean {
	...
	public ShortcutInfo(AppInfoBean info) {
		super(info);
		title = info.title.toString();
		intent = new Intent(info.intent);
		customIcon = false;
	...
	public void initFlagsAndFirstInstallTime(PackageInfo pi) {
		flags = AppInfoBean.initFlags(pi);
		firstInstallTime = AppInfoBean.initFirstInstallTime(pi);
	}
	 ...
	 *            the launch flags
	 */
	public final void setActivity(Context context, ComponentName className, int launchFlags) {
