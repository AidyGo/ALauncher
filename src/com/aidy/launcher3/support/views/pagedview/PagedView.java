...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
	...
	public float[] mapPointFromViewToParent(View v, float x, float y) {
		mTmpPoint[0] = x;
		mTmpPoint[1] = y;
	...
	public float[] mapPointFromParentToView(View v, float x, float y) {
	...
	public void snapToPage(int whichPage, int duration, boolean immediate) {
	...
	public void snapToPage(int whichPage, int delta, int duration, boolean immediate) {
		mNextPage = whichPage;
