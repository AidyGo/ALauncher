...
public class Cling extends FrameLayout implements Insettable, View.OnClickListener, View.OnLongClickListener,
	...
	public static final String FOLDER_CLING_DISMISSED_KEY = "cling_gel.folder.dismissed";
	...
	public void init(Launcher l, View scrim) {
		if (!mIsInitialized) {
			mLauncher = l;
			mScrimView = scrim;
	...
	public void setFocusedHotseatApp(int drawableId, int appRank, ComponentName cn, String title, String description) {
		// Get the app to draw
		...
		if (hotseat != null && appIconId > -1 && appRank > -1 && !title.isEmpty() && !description.isEmpty()) {
			...
			mFocusedHotseatAppBounds = new Rect(pos.left, pos.top, pos.left + Utilities.sIconTextureWidth, pos.top
	...
	public void show(boolean animate, int duration) {
	...
	public void hide(final int duration, final Runnable postCb) {
	...
	protected void dispatchDraw(Canvas canvas) {
		if (mIsInitialized) {
			...
			} else if (mDrawIdentifier.equals(WORKSPACE_PORTRAIT) || mDrawIdentifier.equals(WORKSPACE_LANDSCAPE)
					|| mDrawIdentifier.equals(WORKSPACE_LARGE)) {
