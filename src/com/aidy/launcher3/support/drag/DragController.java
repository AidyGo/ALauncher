...
public class DragController {
	...
	public void startDrag(Bitmap b, int dragLayerX, int dragLayerY, DragSource source, Object dragInfo, int dragAction,
		...
		final DragView dragView = mDragObject.dragView = new DragView(mLauncher, b, registrationX, registrationY, 0, 0,
	...
	public void onAppsRemoved(ArrayList<AppInfoBean> appInfos, Context context) {
