...
import com.aidy.launcher3.FolderIcon.FolderRingAnimator;
import com.aidy.launcher3.Launcher.CustomContentCallbacks;
import com.aidy.launcher3.LauncherSettings.Favorites;
...
public class Workspace extends SmoothPagedView implements DropTarget, DragSource, DragScroller, View.OnTouchListener,
	...
	protected void setWallpaperDimension() {
		...
		WallpaperPickerActivity.suggestWallpaperDimension(mLauncher.getResources(), sp, mLauncher.getWindowManager(), mWallpaperManager);
	}
	...
	protected void onWallpaperTap(MotionEvent ev) {
		...
		mWallpaperManager.sendWallpaperCommand(getWindowToken(), ev.getAction() == MotionEvent.ACTION_UP ? WallpaperManager.COMMAND_TAP
	...
	public void beginDragShared(View child, DragSource source) {
		...
		mDragController.startDrag(b, dragLayerX, dragLayerY, source, child.getTag(), DragController.DRAG_ACTION_MOVE, dragVisualizeOffset,
				dragRect, scale);
	...
	public boolean acceptDrop(DragObject d) {
		...
		if (d.dragSource != this) {
			...
			mTargetCell = findNearestArea((int) mDragViewVisualCenter[0], (int) mDragViewVisualCenter[1], minSpanX, minSpanY,
			...
			mTargetCell = dropTargetLayout.createArea((int) mDragViewVisualCenter[0], (int) mDragViewVisualCenter[1], minSpanX, minSpanY,
	...
	public void onDrop(final DragObject d) {
		...
		if (d.dragSource != this) {
			...
			if (dropTargetLayout != null && !d.cancelled) {
				...
				int[] resultSpan = new int[2];
				mTargetCell = dropTargetLayout.createArea((int) mDragViewVisualCenter[0], (int) mDragViewVisualCenter[1], minSpanX,
						minSpanY, spanX, spanY, cell, mTargetCell, resultSpan, CellLayout.MODE_ON_DROP);
	...
	public void onDragOver(DragObject d) {
		...
		if (mDragTargetLayout != null) {
			...
			float targetCellDistance = mDragTargetLayout.getDistanceFromCell(mDragViewVisualCenter[0], mDragViewVisualCenter[1],
					mTargetCell);
			...
			boolean nearestDropOccupied = mDragTargetLayout.isNearestDropLocationOccupied((int) mDragViewVisualCenter[0],
			...
			if (!nearestDropOccupied) {
				...
				ReorderAlarmListener listener = new ReorderAlarmListener(mDragViewVisualCenter, minSpanX, minSpanY, item.spanX, item.spanY,
						d.dragView, child);
	...
	class ReorderAlarmListener implements OnAlarmListener {
		...
		public void onAlarm(Alarm alarm) {
			...
			mTargetCell = mDragTargetLayout.createArea((int) mDragViewVisualCenter[0], (int) mDragViewVisualCenter[1], minSpanX, minSpanY,
	...
	private void onDropExternal(final int[] touchXY, final Object dragInfo, final CellLayout cellLayout, boolean insertAtFirst, DragObject d) {
		...
		if (info instanceof PendingAddItemInfo) {
			...
			if (findNearestVacantCell) {
				...
				int[] resultSpan = new int[2];
				mTargetCell = cellLayout.createArea((int) mDragViewVisualCenter[0], (int) mDragViewVisualCenter[1], minSpanX, minSpanY,
			...
			if (touchXY != null) {
				...
				mTargetCell = cellLayout.createArea((int) mDragViewVisualCenter[0], (int) mDragViewVisualCenter[1], 1, 1, 1, 1, null,
